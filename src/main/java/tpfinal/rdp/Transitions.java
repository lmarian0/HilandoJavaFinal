 ...
 * Cada transición tiene asociada una ventana de tiempo [alpha, beta] expresada en milisegundos,
 * donde alpha (EFT) es el tiempo mínimo de sensibilización y beta (LFT) es el tiempo máximo (infinito).
 */
